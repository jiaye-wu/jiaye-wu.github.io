...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        description: "an invited talk on temporal Talbot effect",
        section: "Posts",
        handler: () => {
          
            window.location.href = "/blog/2026/invited-THU/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-organize-conference-session-advances-in-near-zero-index-metasurfaces-nanodevices-and-on-chip-integration-in-piers-2027-piers-2027-daejeon-south-korea-session-details-co-organizer-prof-qian-li-peking-university",
          title: 'Organize conference session “Advances in Near-zero-index Metasurfaces, Nanodevices, and On-chip Integration” in PIERS...',
          description: "",
