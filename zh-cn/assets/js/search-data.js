...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/zh-cn/";
          ...
          title: "招生招聘",
          description: "本实验室长期招募各类领军博士后学者和优秀学生",
          section: "导航菜单",
          handler: () => {
          ...
          handler: () => {
            window.location.href = "/zh-cn/contact/";
              ...
              section: "更多",
              handler: () => {
                window.location.href = "/zh-cn/links/";
              },
            },{id: "dropdown-代码仓库",
              title: "代码仓库",
              description: "",
        ...
        handler: () => {
            ...
            window.location.href = "/zh-cn/blog/2026/dev-ExportMyPub/";
          
        },
      },{id: "post-受邀讲座-新型时域泰伯效应及其片上集成",
        
          title: "[受邀讲座] 新型时域泰伯效应及其片上集成",
        
        description: "时域泰伯效应系列受邀讲座",
        section: "博文",
        handler: () => {
          
            window.location.href = "/zh-cn/blog/2026/invited-THU/";
          
        },
      },{id: "post-学术工具-l-39-acaradar项目",
        ...
        handler: () => {
            ...
            window.location.href = "/zh-cn/blog/2026/dev-LAcaRadar/";
        ...
        handler: () => {
          ...
          description: "",
          section: "新闻",},{id: "news-担任piers-2026学术会议分会场-session-组织-near-zero-index-photonics-physics-devices-and-applications-piers-2026-中国江苏苏州-分会场信息-共同组织者-北京大学-李倩-副教授",
          title: '担任PIERS 2026学术会议分会场（Session）组织：”Near-Zero-Index Photonics: Physics, Devices, and Applications” PIERS 2026，中国江苏苏州 分会场信息 | 共同组织者：北京大学 李倩...',
          description: "",
          section: "新闻",},{id: "news-吴嘉野-博士-被任命为香港城市大学-东莞-助理教授",
          title: '吴嘉野 博士 被任命为香港城市大学（东莞）助理教授',
          description: "",
          section: "新闻",},{id: "news-担任piers-2027学术会议分会场-session-组织-advances-in-near-zero-index-metasurfaces-nanodevices-and-on-chip-integration-piers-2027-韩国大田广域市-分会场信息-共同组织者-北京大学-李倩-副教授",
          title: '担任PIERS 2027学术会议分会场（Session）组织：”Advances in Near-zero-index Metasurfaces, Nanodevices, and On-chip Integration” PIERS 2027，韩国大田广域市 分会场信息 |...',
          description: "",
          section: "新闻",},{id: "projects-算法驱动的光子学设计",
          title: '算法驱动的光子学设计',
          description: "利用先进算法与机器学习加速并优化光子器件开发",
          section: "课题",handler: () => {
              window.location.href = "/zh-cn/projects/proj_ai_photonics/";
            },},{id: "projects-近零折射率光子学",
          title: '近零折射率光子学',
          description: "探索极低折射率介质中的电磁波传播特性与光与物质相互作用",
          section: "课题",handler: () => {
              window.location.href = "/zh-cn/projects/proj_enz_photonics/";
            },},{id: "projects-集成光器件与光芯片",
          title: '集成光器件与光芯片',
          description: "指尖尺度的非常规光与物质相互作用",
          section: "课题",handler: () => {
              window.location.href = "/zh-cn/projects/proj_integrated_optics/";
            },},{id: "projects-面向人工智能的光子学",
          title: '面向人工智能的光子学',
          description: "基于光计算架构开发高速度、低功耗的人工智能硬件加速器",
          section: "课题",handler: () => {
              window.location.href = "/zh-cn/projects/proj_photonic_computation/";
            },},{id: "projects-互联光波导网络",
          title: '互联光波导网络',
          description: "构建宏观人工超晶格，探索奇异光波传播与拓扑光场调控",
          section: "课题",handler: () => {
              window.location.href = "/zh-cn/projects/proj_pt_topo/";
            },},{id: "projects-光子辐射制冷",
          title: '光子辐射制冷',
          description: "利用微纳光子学实现可持续的被动热管理",
          section: "课题",handler: () => {
